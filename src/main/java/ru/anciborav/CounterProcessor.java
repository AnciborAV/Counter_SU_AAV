package ru.anciborav;

import java.io.BufferedReader;
import java.io.IOException;
import java.io.InputStreamReader;

import static ru.anciborav.Constants.INCREMENT;
import static ru.anciborav.Constants.RESET;
import static ru.anciborav.Constants.STOP;
				...
				while (true) {
						...
						switch (line) {
								...
								case STOP -> {
										...
										System.out.println("I'm finishing work! Current value is: " + value);
										break theBank;
								}
								case RESET -> {
										var value = counterHolder.reset();
										System.out.println("The counter has been reset! Value is: " + value);
								}
